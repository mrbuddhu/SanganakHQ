    ...
    <MainLayout>
      <section className="min-h-screen py-16">
        <div className="container mx-auto px-4">
          <LuxuryHeading title="Ecommerce" subtitle="Conversion-first growth for premium DTC" />
        </div>
      </section>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Ecommerce', item: 'https://sanganak.org/industries/ecommerce' }
            ]
          })
        }}
      />
