...
export const metadata: Metadata = {
  ...
  description: 'SanganakHQ delivers premium web development, mobile app development, branding, design, digital marketing, AI solutions, blockchain development, and smart contract services using Framer, Webflow, FlutterFlow, WordPress, React, React Native, OpenAI, Ethereum, Solana, and cutting-edge tools. Elite innovation solutions helping startups launch faster, brands grow smarter, and enterprises innovate at scale.',
  ...
  openGraph: {
    title: 'SanganakHQ | Branding • Design • Web Development • Mobile Apps • AI • Blockchain • Marketing',
    description: 'SanganakHQ delivers premium innovation solutions. Elite tech solutions across branding, design, websites, applications, AI, blockchain, and marketing. Helping startups launch faster, brands grow smarter, and enterprises innovate at scale.',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
...
const jsonLd = {
  ...
  '@type': 'Organization',
  name: 'SanganakHQ',
  alternateName: ['Sanganak Technologies', 'SanganakHQ Technologies', 'Sanganak Tech', 'SanganakHQ Tech', 'Launch Faster. Grow Smarter. Innovate at Scale.'],
  url: 'https://sanganak.org',
