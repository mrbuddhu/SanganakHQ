...
export const metadata: Metadata = {
  title: 'SanganakHQ | Branding • Design • Web & Mobile Apps • AI • Blockchain • Marketing',
  description: 'SanganakHQ delivers elite solutions in weeks, not months. Ship faster, lift conversions, and lead your market with our premium branding, design, web & mobile apps, AI, blockchain, and marketing services.',
